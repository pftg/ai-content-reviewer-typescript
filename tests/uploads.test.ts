import fs from 'fs';
import type { ResponseLike } from 'ai-content-reviewer/internal/to-file';
import { toFile } from 'ai-content-reviewer/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('ai-content-reviewer/core/uploads');
    await expect(
